...
2. オンボードの**赤 LED**（K210 IO13, アクティブLow）を点滅させる
...
```
Hello from Rust on K210 (Maixduino)!
LED on
LED off
LED on
...
...
ビルド・リンクは通過。書き込み/シリアルは docs を参照。カメラ(DVP)と WiFi(オンボード
ESP32)は到達可能だが、まだ既製の Rust ドライバは無い:
